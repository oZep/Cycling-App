...
public class AdminManageAccounts extends AppCompatActivity {
    ...
    Button goBackToHomepage, goBackToAdminControls;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goBackToAdminControls = findViewById(R.id.goToHomepageAdmin);
        ...
        goBackToAdminControls.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
